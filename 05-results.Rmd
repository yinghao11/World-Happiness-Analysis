...
ggplot(mapdata1,aes(x=long,y=lat,group=group)) + geom_polygon(aes(fill=Life.Ladder),color="black") +
  scale_fill_gradient(name="Life Ladder",low="#C6DBEF",high="#08306B") +
...
From the map, it is not hard to tell that the life ladder score is generally higher for European, North America and Oceanian countries. Colors are lighter, thus lower happiness score,  
