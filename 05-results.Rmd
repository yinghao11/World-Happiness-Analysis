...
#betaplot
library(dygraphs)
dygraph(beta_df,main='Standardized Beta, 2008-2020 <br> <small>from regressing life ladder on all variables</small>') %>%
  dyLegend(show = "always", hideOnMouseOut = TRUE,width=) %>%
...
difference_map <- ggplot(mapdata, aes(x = long, y = lat, group = group)) + geom_polygon(aes(fill = difference)) + scale_fill_gradient(name = "Difference", low = "brown2", high = "seagreen")
difference_map
```
